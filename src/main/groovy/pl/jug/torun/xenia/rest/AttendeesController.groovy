...
class AttendeesController {
    ...
    @ResponseBody AttendeesResponse getAttendees() {
        return new AttendeesResponse(attendees: [new AttendeeResponse(id: 1, displayName: 'Szymon', photoUrl: 'http://photos3.meetupstatic.com/photos/member/2/a/3/2/thumb_179350802.jpeg'),
